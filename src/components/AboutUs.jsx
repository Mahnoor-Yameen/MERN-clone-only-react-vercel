...
<div className="mt-5 container" style={{ backgroundColor: "#ffcd33" }}>
      ...
      <div className="row g-4 mb-4 pb-2 ">
                            <div className="col-md-6 col-sm-6 my-4 ">
                                <div className="d-flex align-items-center">
                                    <div className="d-flex flex-shrink-0 align-items-center justify-content-center " style={{backgroundColor:"#ffcd33"}}
                                        >
                                       <FaUsers style={{ fontSize: '45px', backgroundColor:"#ffcd33" }} className=' mx-4'/>                                    </div>
                                    <div >
                            ...
                            <div className="col-md-6 col-sm-6 " >
                                <div className="d-flex align-items-center">
                                    <div className="d-flex flex-shrink-0 align-items-center justify-content-center " style={{backgroundColor:"#ffcd33"}}
                                        >
                                        <FaCheck style={{ fontSize: '45px', backgroundColor:"#ffcd33" }} className=' mx-4'/>
                                    </div>
                                    <div >
